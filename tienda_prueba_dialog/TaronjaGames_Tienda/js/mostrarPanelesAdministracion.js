...
function mostrarPanelesAdmin() {
    var panelAdmin = "<div id='caja-paneles-admin' class='caja-paneles'>\n\
                            <p id='titulo-caja-paneles-admin' class='titulo-caja-paneles'>Panel de Administración</p>\n\
                            <div id='panel-admin-usuario' class='panel-admin' onclick='mostrarListaUsuarios()'>\n\
                            ...
                            <div id='panel-admin-producto' class='panel-admin' onclick='mostrarListaArticulos()'>\n\
