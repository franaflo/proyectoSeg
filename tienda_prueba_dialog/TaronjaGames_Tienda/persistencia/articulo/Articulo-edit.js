...
function mostrarEditArticulo() {
    ...
    $("body").append(datos);//Con html borra la tabla
    ...
    function validarEditArticulo() {
        ...
        selectPlataforma.change(function () {
            errorValidacion += validarOptionRequerido(formulario, this.name, this.value);
        });
        //Formato precio
        inputPrecio.keyup(function () {
            errorValidacion += comprobarPrecio(formulario, this.name, this.value);
        });
