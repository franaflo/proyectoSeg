...
function mostrarDialogEditUsuario() {

    var datos = "<div id='bloqueEditUsuario' class='caja-formulario dialog-editar'>\n\
    ...
    function validarEditUsuario() {
        ...
        inputUsuario.keyup(function () {
            errorValidacion += comprobarEspacios(formulario, this.name, this.value);
        });
        //Formato password
    ...
    //CLICK ENVIAR
    document.getElementById("editUsuario-boton-enviar").onclick = function () {
...
//        errorValidacion = -1;
        if (errorValidacion === 0) {
            ...
            alert("Revise los datos, se han producido errores de validación!");
        }
